            ...
            <div className="container-wide flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-10">
                    <div className={cn("flex items-center gap-8 text-[13px] font-medium uppercase tracking-widest transition-colors", isScrolled ? "text-slate-600" : "text-white/80")}>
                        ...
                        <Link href="/#process" className={cn("hover:opacity-70 transition-opacity", isScrolled ? "hover:text-black" : "hover:text-white")}>Process</Link>
                    </div>
                    <div className={cn("h-4 w-px transition-colors", isScrolled ? "bg-slate-300" : "bg-white/20")} />
                    <div className="flex items-center gap-4">
                        <Link href="/#book-demo" className={cn("text-[13px] font-bold uppercase tracking-widest hover:opacity-70 transition-opacity", isScrolled ? "text-black" : "text-white")}>
                            Try Stealth Out
                        </Link>
                    </div>
                </div>
