...
export default function LoginPage() {
    ...
    // 1. Listen for the session. If we have one, redirect to the app.
    useEffect(() => {
        const supabase = createClient();
        
        // Check if we are already logged in (e.g. returning from Google)
        ...
        // Listen for the specific moment the login happens
    ...
    const handleAppRedirect = (session: any) => {
        setIsSuccess(true);
        // We pass the session tokens back to the desktop app's local HTTP server
        // This is 100% reliable across all OS development environments
        ...
        // Small delay to show the "Success" UI before jumping back to the app
        setTimeout(() => {
                    ...
                    >
                        ...
                        <div className="w-16 h-16 bg-white/[0.03] border border-white/[0.05] rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-inner">
                            <svg className="w-8 h-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.2} d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A10.003 10.003 0 0012 3a9.99 9.99 0 00-4.512 1.076m3.993 13.26l-.12.162a.833.833 0 01-.157.194l-5.617 5.617A1 1 0 011 22V5a1 1 0 011-1h17a1 1 0 011 1v12a1 1 0 01-1 1h-11z" />
                            </svg>
                        </div>
